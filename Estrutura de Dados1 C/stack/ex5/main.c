...
int main(){
    int opc, tam, aux;
    char caracter, top, expre[20], infix[20], posfix[20];
    Stack *pi;
    ...
    do{
        ...
        case 8:
          printf("Infix para posfix!\n");
          getchar();
          printf("Digite a Expressão: ");
            fgets(infix, sizeof(infix), stdin);
          printf("\nExpressão  = %s", infix);
          aux = infix_to_posfix(pi, infix, posfix);
          if(aux == 0){
            printf("ERRO!\n");
          }else{
            printf("Expressão em posfix = %s\n", posfix);
          }
          break;
